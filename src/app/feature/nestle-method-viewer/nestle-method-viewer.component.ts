...
@Component({
  selector: 'app-nestle-method-viewer',
  templateUrl: './nestle-method-viewer.component.html',
  styleUrls: ['./nestle-method-viewer.component.scss'],
})
export class NestleMethodViewerComponent implements OnInit, OnDestroy {
