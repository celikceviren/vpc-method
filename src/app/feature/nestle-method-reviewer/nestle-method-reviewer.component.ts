...
@Component({
  selector: 'app-nestle-method-reviewer',
  templateUrl: './nestle-method-reviewer.component.html',
  styleUrls: ['./nestle-method-reviewer.component.scss'],
})
export class NestleMethodReviewerComponent implements OnInit, OnDestroy {
